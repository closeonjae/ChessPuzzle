...
// Chessboard
val BoardLight = Color(0xFFEDEAE1)
val BoardDark = Color(0xFF7C6A58)
val PieceWhiteFill = Color(0xFFFFFFFF)
val PieceWhiteStroke = Color(0xFF1A1816)
val PieceBlackFill = Color(0xFF1A1816)
val PieceBlackStroke = Color(0xFFFFFFFF)
